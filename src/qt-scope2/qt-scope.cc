...
class ScopeWidget : public QOpenGLWidget, protected QOpenGLFunctions_1_0 {
public:
...
ScopeWidget::ScopeWidget (QWidget * p) :  QOpenGLWidget (p), vec(512)
{
    resize (width (), height ());
}
...
void ScopeWidget::initializeGL ()
{
    initializeOpenGLFunctions ();
}

void ScopeWidget::paintGL ()
{
    QPainter p(this);
...
void ScopeWidget::resizeGL (int w, int h)
{
    resize (w, h);
}
